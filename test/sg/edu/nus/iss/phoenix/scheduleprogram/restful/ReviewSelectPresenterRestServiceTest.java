...
public class ReviewSelectPresenterRestServiceTest {
    ...
    public ReviewSelectPresenterRestServiceTest() {
    }
    ...
    public void setUp() throws SQLException {
        ...
        user1.setAll("pointy", "pointy", "Head", "presenter");
        user2.setAll("tommy", "hil", "THF", "presenter");
        
        userList.add(user1);
        userList.add(user2);
        
        
        when(userDao.loadUserBasedOnRole("presenter")).thenReturn(userList);
    ...
    public void testGetPresenter() {
        ...
        ArrayList<User> listUser = service.loadUserBasedOnRole("presenter");
        ...
        assertThat(role,hasItem(hasProperty("role", is("presenter"))));
    }
